...
/*rollback to savepoint all_input;
rollback to savepoint Client2;
rollback to savepoint worker2;
rollback to savepoint rent2;
rollback to savepoint insurance2;
rollback to savepoint bike_producer2;
rollback to savepoint bike2;
rollback to savepoint damage2;
rollback to savepoint accessory2;
rollback to savepoint rent_has_accessory2;
rollback to savepoint bike_has_rent2;*/
